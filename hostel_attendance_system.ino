...
Serial.println();
content.toUpperCase();
if (content.substring(1) == "60 89 4E 30") //change here the UID of the card/cards that you want to give access
{
lcd.print("1. ISHITA PATIL");
lcd.setCursor(0,1);
lcd.print("PRESENT");
...
lcd.clear();
}else if (content.substring(1) == "F7 3B 30 B2") //change here the UID of the card/cards that you want to give access
{
lcd.print("2. AKSHAY RATHOD");
lcd.setCursor(0,1);
lcd.print("PRESENT");
digitalWrite(LED_G, HIGH);
tone(BUZZER, 500);
